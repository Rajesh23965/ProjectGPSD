...
const Footer = ({ base }) => {
  ...
  return (
    <footer className="bg-[#115404] flex-col md:flex-row justify-between mr-8 lg:ml-8 lg:mt-8 p-4">
      {footerData.length > 0 && (
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 md:flex md:flex-row lg:flex-row justify-between">
            {/* Left Section: Contact Us & Follow Us */}
            <div className="space-y-8">
              {/* Contact Us */}
              {footerData
                .filter((foot) => foot.footer_id === "1")
                .map((foot, index) => (
                  <div key={index}>
                    <h2 className="text-white  text-lg md:text-xl lg:text-2xl font-semibold mb-4 underline underline-offset-8 decoration-[#087830]">
                      {foot.footer_title}
                    </h2>
                    <div
